                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                      ...
                      <div>
                        ...
                        <span style={{ fontSize: '0.85rem', color: '#64748b' }}>
                          {item.vertical || 'School Academics'} • {item.category} • {item.subject} • {item.resourceType}
                        </span>
                      </div>
                    </div>
                ...
                {!selectedVertical && (
                    <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
                            ...
                            {/* Current Affairs Card (Placeholder) */}
                            <div style={{...verticalCardStyle, opacity: 0.6, cursor: 'not-allowed'}} title="Coming Soon!">
                                <div style={{ fontSize: '4rem', marginBottom: '15px' }}>🌍</div>
                                <h2 style={{ color: '#1e293b', margin: '0 0 10px 0' }}>Current Affairs</h2>
                                <p style={{ color: '#64748b', margin: 0 }}>Daily updates and monthly PDF magazines.</p>
                                <span style={comingSoonBadge}>Coming Soon</span>
                            </div>
